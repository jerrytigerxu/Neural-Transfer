...
## 4. Intuition on the math and the loss function
## 5. Processing and deprocessing images
## 6. Training network
...
```
    ...
    'Data Science   Machine Learning'  'Finance Stuff'
...
```
    ...
    'better silly.jpg'     images			       'Trial 1'
    'better thought.jpg'  'Neural Transfer Project.ipynb'  'Trial 2'
...
```
    ...
    Iteration:  0
    Current loss value: 4263225600.0
    Iteration:  1
    Current loss value: 2730956500.0
    Iteration:  2
    Current loss value: 2215422700.0
    Iteration:  3
